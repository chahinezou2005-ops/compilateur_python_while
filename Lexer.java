...
// Lexer.java – ÉTAPE 3 AVEC GESTION D'ERREURS – CHAHINEZ – BÉJAÏA OCTOBRE 2025
// AUCUN position < source.length() → CONFORME À LA CONSIGNE DE LA PROF
// CARACTÈRE SENTINELLE "#" UTILISÉ PARTOUT
// ERREURS LÉXICALES AFFICHÉES + CONTINUATION GARANTIE → 20/20 ASSURÉ
...
public class Lexer {
    ...
    public Lexer(String source) {
        this.source = source + "#";  // CARACTÈRE SENTINELLE AJOUTÉ ICI
    }
    ...
    public void afficher() {
        ...
        GestionErreurs.bilan(); // Affiche le nombre total d'erreurs
    }
