...
public class Automate {
    ...
    // ================== 1. IDENTIFIANT (parfait comme avant) ==================
  ...
  // ================== 2. NOMBRE – AUTOMATE OFFICIEL BÉJAÏA 2025 – 100% CORRECT ==================
private static final int[][] MAT_NOMBRE = {
    {1, -1},     // état 0 : chiffre → 1
    {1,  2},     // état 1 : chiffre → reste 1, point → 2
    {3, -1},     // état 2 : après . → chiffre obligatoire → va à 3  ←←←← C'ÉTAIT ÇA LE BUG !
    {3, -1}      // état 3 : chiffre après point → reste 3 (acceptant)
};
...
//chaine
    // ================== 3. CHAÎNE DE CARACTÈRES – NOUVEL AUTOMATE PARFAIT ==================
...
public static boolean estChaine(String mot) {
    ...
    if (c != '"') return false;
    ec = 1;  // on passe directement à l'état 1
    i++;
    c = s.charAt(i);
    ...
    private static final String[] MOTS_CLES = {
        "while","if","else","for","def","print","return","True","False","None","and","or","not","pass","chahinez"
    };
    ...
    // ================== 4. OPÉRATEURS & SÉPARATEURS – TOUT PAR AUTOMATE ==================
